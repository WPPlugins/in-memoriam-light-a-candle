...
function shortcode_candle_submission ( $atts ) {
	...
	if( isset( $_POST['candle-postback'] ) && wp_verify_nonce( $_POST['candle_nonce'], 'add-candle' ) ):
      ...
      if( 1 == get_option('imlac_candle_publish_notification')) {
        update_post_meta( $post_id, 'candle_prayer_email', sanitize_text_field( $_POST['candle_prayer_email'] ) );
        update_post_meta( $post_id, 'candle_title_email', sanitize_text_field( $_POST['candle_title_email'] ) );
      }
    ...
    <?php if( 1 == get_option('imlac_candle_publish_notification')) : ?>
      <label for="candle_title_email"><?php _e( 'Email to notify of your prayer (optional):' ,'in-memoriam-light-a-candle' ); ?> </label><br />
      <input type="text" maxlength="65" size="65" name="candle_title_email" id="candle_title_email"/><br /><br />
    <?php endif; ?>
    ...
    <?php if( 1 == get_option('imlac_candle_publish_notification')) : ?>
      <label for="candle_prayer_email"><?php _e( 'Your Email (optional):', 'in-memoriam-light-a-candle' ); ?></label><br />
      <input type="text" maxlength="65" size="65" name="candle_prayer_email" id="candle_prayer_email"/><br /><br />
    <?php endif; ?>
