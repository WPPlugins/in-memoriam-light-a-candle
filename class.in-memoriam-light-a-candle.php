...
final class Plugify_Light_Candles {
	...
	*/
	...
	public static function candle_metabox ( $post ) {
      ...
      <?php if( 1 == get_option('imlac_candle_publish_notification')) : ?>
        <tr>
          <td valign="middle" align="left" width="125"><label for="candle_prayer_email"><?php _e( 'Prayer Email', 'in-memoriam-light-a-candle' ); ?></label></td>
          <td valign="middle" align="left" width="150"><input type="text" name="candle_prayer_email" value="<?php echo esc_attr( get_post_meta( $post->ID, 'candle_prayer_email', true ) ); ?>" />
          <td valign="middle" align="left"><em><?php _e( 'Notification will be sent here upon publication', 'in-memoriam-light-a-candle' ); ?></em></td>
        </tr>
      <?php endif; ?>
			<tr>
      ...
      <?php if( 1 == get_option('imlac_candle_publish_notification')) : ?>
        <tr>
          <td valign="middle" align="left" width="125"><label for="candle_title_email"><?php _e( 'Recipient Email', 'in-memoriam-light-a-candle' ); ?></label></td>
          <td valign="middle" align="left" width="150"><input type="text" name="candle_title_email" value="<?php echo esc_attr( get_post_meta( $post->ID, 'candle_title_email', true ) ); ?>" />
          <td valign="middle" align="left"><em><?php _e( 'Notification will be sent here upon publication', 'in-memoriam-light-a-candle' ); ?></em></td>
        </tr>
      <?php endif; ?>
