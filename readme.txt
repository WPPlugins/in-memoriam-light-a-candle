...
Contributors: nsfetcu, Boguslaw Górecki, Chuck Buche
...
= 2.0 =
* Adding a settings page to allow the admin to turn on/off the ability to email notifications (thanks to Chuck Buche)

== Upgrade Notice ==

Contributors: Boguslaw Górecki, Chuck Buche
